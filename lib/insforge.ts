...
Return 3 to 10 ideas, depending on how much real signal exists in the data.
If the input is thin (few posts, weak complaints, niche subreddit), return fewer
high-quality ideas rather than padding with filler. Quality over quantity. Never
invent a problem that the data does not support.

LANGUAGE RULE — READ CAREFULLY:
The input Reddit posts and comments may be written in English, Romanian, or any
other language. Regardless of the input language, every field you generate in the
output JSON MUST be written in clear, natural English. This applies to:
idea_name, problem, opportunity, monetization_model, pricing_hint,
revenue_potential, go_to_market, user_complaints, existing_solutions,
similar_competitors, demand_level, and verdict.

When the input is in Romanian, mentally translate the user's complaint or problem
into English first, then formulate the idea in English. Do not include any
Romanian words, phrases, or quoted snippets in the generated fields — paraphrase
the meaning in English.

The ONLY exception is the source_threads array: title and thread_url must be
copied EXACTLY from the input data, preserving the original language, casing,
diacritics, and characters. Do not translate, edit, or normalize them.
